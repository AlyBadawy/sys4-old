...
export const Home = () => {
  return (
    <>
      <main className='flex-1 container mx-auto' id='layout-main'>
        <NavBar />
        <section id='home-hero'>
          <div className='container flex flex-col-reverse items-center px-6 mx-auto mt-24 mb-32 space-y-6 space-y-reverse md:flex-row '>
            {/* Hero-Text */}
            <div className='flex flex-col mb-12 space-y-12 md:w-1/2'>
              ...
              <p className='max-w-md text-center text-gray-400 md:text-left'>
                ...
                socializing with friends, education, health, news, and much
                more. With <Sys4Text />, you can enjoy a seamless experience
                across multiple domains, all in one convenient location.
              </p>
        ...
        <section id='home-features'>
          <div className='container flex flex-col px-4 mx-auto my-10 space-y-12 md:space-y-0 md:flex-row'>
            ...
            <div className='flex flex-col space-y-8 md:w-1/2  md:max-w-md'>
              <SystemSectionItem number='01' title='System for Development'>
                ...
                developers. It offers a range of tools, including IDEs,
                compilers, debuggers, and libraries. The system also offers
                collaboration features, allowing users to work on projects
                together.
              </SystemSectionItem>
              <SystemSectionItem number='02' title='System for News'>
                The News System provides users with the latest news and current
                events from around the world. Users can customize their news
                feed, select specific topics, and get alerts on breaking news.
                The system also offers editorial content, opinion pieces, and
                multimedia content.
              </SystemSectionItem>
              ...
              <SystemSectionItem number='04' title='System for Education'>
                The Education System offers learning resources, including
                courses, tutorials, and educational videos. Users can learn new
                skills, improve their knowledge, and earn certifications. The
                system also offers gamification features, allowing users to earn
                badges and rewards for completing courses.
              </SystemSectionItem>
              <SystemSectionItem number='05' title='System for Productivity'>
                The Productivity System helps users manage their time and
                productivity. The system offers features such as task
                management, time tracking, and calendar management. Users can
                also access articles and videos related to productivity and time
                management.
              </SystemSectionItem>
            </div>
          </div>
