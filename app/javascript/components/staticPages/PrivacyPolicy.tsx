          ...
          <ul className='list-decimal list-inside'>
            <li className='mt-4 mb-1'>
              ...
              <ul className='list-disc list-inside'>
                ...
                <li>
                  Usage information: such as your device information, IP
                  address, and browsing behavior.
                </li>
                <li>
                  Location information: such as your current location, if you
            ...
            <li className='mt-4 mb-1'>
              ...
              <ul className='list-disc list-inside'>
                ...
                <li>
                  Communicate with you about our application and related
                  services.
                </li>
            ...
            <li className='mt-4 mb-1'>
              ...
              <ul className='list-disc list-inside'>
                ...
                <li>
                  ...
                  when required by law or to protect our rights or the rights of
                  others.
                </li>
              </ul>
            </li>
            <li className='mt-4 mb-1'>
              ...
              <ul className='list-disc list-inside'>
                <li>
                  Limit the information we collect by adjusting the settings on
                  your device or browser.
                </li>
                <li>
                  Opt-out of receiving marketing communications from us by
                  following the instructions in the communications.
                </li>
              </ul>
            </li>
            <li className='mt-4 mb-1'>
            ...
            <li className='mt-4 mb-1'>
              ...
              <p>
                ...
                Privacy Policy will be posted on our website and will be
