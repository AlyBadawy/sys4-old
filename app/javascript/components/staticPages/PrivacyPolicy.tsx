    ...
    <>
      <section id='privacy-policy'>
        ...
        <div className='max-w-5xl'>
          ...
          <h4 className='text-3xl mt-4 mb-1'>Information We Collect</h4>
          <p>
          ...
          <h4 className='text-3xl mt-4 mb-1'>How We Use Your Information</h4>
          ...
          <h4 className='text-3xl mt-4 mb-1'>How We Share Your Information</h4>
          ...
          <h4 className='text-3xl mt-4 mb-1'>Your Choices</h4>
          ...
          <h4 className='text-3xl mt-4 mb-1'>Security</h4>
          <p>
          ...
          <h4 className='text-3xl mt-4 mb-1'>Changes to this Privacy Policy</h4>
          <p>
            We may update this Privacy Policy from time to time. The updated
            Privacy Policy will be posted on our website and will be effective
            as of the date of posting.
          </p>
          <h4 className='text-3xl mt-4 mb-1'>Contact Us</h4>
          <p>
